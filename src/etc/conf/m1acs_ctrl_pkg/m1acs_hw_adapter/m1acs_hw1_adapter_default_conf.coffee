...
# Component  m1acs_hw1_adapter instance configuration file
# Ports should be setup per instance

module.exports =

    properties:
        uri: { name: 'uri', default_value: 'gmt://127.0.0.1/m1acs_dcs/m1acs_hw1_adapter' , type: 'string', desc: 'Uri path for the component' }
        name: { name: 'name', default_value: 'm1acs_hw_adapter' , type: 'string', desc: 'Name the component' }
