#ifndef _m1acs_resistor_bridge_status_t_h_
#define _m1acs_resistor_bridge_status_t_h_
...
struct m1acs_resistor_bridge_status_t {
    ...
    uint32_t                 bridge_serial_number; // bridge_serial_number (from module)
    ...
    float                    bridge_tara_float;   // bridge_tara_float (from module)
