...
#include "M1acsHwAdapterSetup.h"
#include "M1acsHwAdapterBase.h"

using namespace std;
using namespace gmt;

M1acsHwAdapterBase::M1acsHwAdapterBase(
...
void M1acsHwAdapterBase::create_state()
{
    //create the features inherited from the base class
    Base::create_state();

    //create the input dataio of the class, and assign the default value
    new_input_dataio(digital_out,               "digital_out",           m1acs_digital_out_t());
    new_input_dataio(analog_out,                "analog_out",            m1acs_analog_out_t());
    new_input_dataio(resistor_bridge_control,   "resistor_bridge_control", std::array<m1acs_resistor_bridge_control_t, 7>());

    //create the output dataio of the class, and assign the default value
    new_output_dataio(digital_in,                "digital_in",            m1acs_digital_in_t());
    new_output_dataio(analog_in,                 "analog_in",             m1acs_analog_in_t());
    new_output_dataio(ssi_in,                    "ssi_in",                std::array<m1acs_ssi_in_t, 4>());
    new_output_dataio(power_supply,              "power_supply",          std::array<m1acs_power_supply_t, 4>());
    new_output_dataio(resistor_bridge_status,    "resistor_bridge_status", std::array<m1acs_resistor_bridge_status_t, 7>());
...
void M1acsHwAdapterBase::configure_from_file (const std::string& fname)
{
    try
    {
...
void M1acsHwAdapterBase::setup_state(ComponentSetup& config)
{
    ...
    create_data_object_ref(resistor_bridge_control[1].bridge_tara_float, "bridge_1_tara_float_rx");
    ...
    create_data_object_ref(resistor_bridge_status[1].bridge_serial_number, "bridge_1_serial_number_tx");
    ...
    create_data_object_ref(resistor_bridge_status[1].bridge_tara_float, "bridge_1_tara_float_tx");
    ...
    create_data_object_ref(resistor_bridge_control[2].bridge_tara_float, "bridge_2_tara_float_rx");
    ...
    create_data_object_ref(resistor_bridge_status[2].bridge_serial_number, "bridge_2_serial_number_tx");
    ...
    create_data_object_ref(resistor_bridge_status[2].bridge_tara_float, "bridge_2_tara_float_tx");
    ...
    create_data_object_ref(resistor_bridge_control[3].bridge_tara_float, "bridge_3_tara_float_rx");
    ...
    create_data_object_ref(resistor_bridge_status[3].bridge_serial_number, "bridge_3_serial_number_tx");
    ...
    create_data_object_ref(resistor_bridge_status[3].bridge_tara_float, "bridge_3_tara_float_tx");
    ...
    create_data_object_ref(resistor_bridge_control[4].bridge_tara_float, "bridge_4_tara_float_rx");
    ...
    create_data_object_ref(resistor_bridge_status[4].bridge_serial_number, "bridge_4_serial_number_tx");
    ...
    create_data_object_ref(resistor_bridge_status[4].bridge_tara_float, "bridge_4_tara_float_tx");
    ...
    create_data_object_ref(resistor_bridge_control[5].bridge_tara_float, "bridge_5_tara_float_rx");
    ...
    create_data_object_ref(resistor_bridge_status[5].bridge_serial_number, "bridge_5_serial_number_tx");
    ...
    create_data_object_ref(resistor_bridge_status[5].bridge_tara_float, "bridge_5_tara_float_tx");
    ...
    create_data_object_ref(resistor_bridge_control[6].bridge_tara_float, "bridge_6_tara_float_rx");
    ...
    create_data_object_ref(resistor_bridge_status[6].bridge_serial_number, "bridge_6_serial_number_tx");
    ...
    create_data_object_ref(resistor_bridge_status[6].bridge_tara_float, "bridge_6_tara_float_tx");
