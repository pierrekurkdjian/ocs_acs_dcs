Adapter            'm1acs_hw_adapter',
    info:          'M1 ACS Hw Adapter'
    desc:          'This component defines the interface with M1 the ACS sensors'
    abstract:      false
    extends:       ['EthercatAdapter']
    uses:          ["ocs_core_fwk", "ocs_io_fwk"]

    input_ports:
        digital_out:             { type: 'm1acs_digital_out_t',                protocol: 'pull', max_rate: 1000, blocking_mode: 'sync', owner: true,  desc: 'Digital output (values)' }
        analog_out:              { type: 'm1acs_analog_out_t',                 protocol: 'pull', max_rate: 1000, blocking_mode: 'sync', owner: true,  desc: 'Analog output (values)' }
        resistor_bridge_control: { type: 'm1acs_resistor_bridge_control_t[7]', protocol: 'pull', max_rate: 1000, blocking_mode: 'sync', owner: true,  desc: 'Resistor bridge control' }

    output_ports:
        digital_in:              { type: 'm1acs_digital_in_t',                 protocol: 'push', max_rate: 1000, blocking_mode: 'sync', owner: false, desc: 'Digital input (values)' }
        analog_in:               { type: 'm1acs_analog_in_t',                  protocol: 'push', max_rate: 1000, blocking_mode: 'sync', owner: false, desc: 'Analog input (values + status)' }
        ssi_in:                  { type: 'm1acs_ssi_in_t[4]',                  protocol: 'push', max_rate: 1000, blocking_mode: 'sync', owner: false, desc: 'SSI input (values + status)' }
        power_supply:            { type: 'm1acs_power_supply_t[4]',            protocol: 'push', max_rate: 1000, blocking_mode: 'sync', owner: false, desc: 'Power supply state' }
        resistor_bridge_status:  { type: 'm1acs_resistor_bridge_status_t[7]',  protocol: 'push', max_rate: 1000, blocking_mode: 'sync', owner: false, desc: 'Resistor bridge status' }
    ...
    data_object_map: [
        ...
        { data_object: "bridge_1_tara_float_rx",                 port: "resistor_bridge_control[1]",         field: "bridge_tara_float" }
        ...
        { data_object: "bridge_1_serial_number_tx",              port: "resistor_bridge_status[1]",         field: "bridge_serial_number" }
        ...
        { data_object: "bridge_1_tara_float_tx",                 port: "resistor_bridge_status[1]",         field: "bridge_tara_float" }
        ...
        { data_object: "bridge_2_tara_float_rx",                 port: "resistor_bridge_control[2]",         field: "bridge_tara_float" }
        ...
        { data_object: "bridge_2_serial_number_tx",              port: "resistor_bridge_status[2]",         field: "bridge_serial_number" }
        ...
        { data_object: "bridge_2_tara_float_tx",                 port: "resistor_bridge_status[2]",         field: "bridge_tara_float" }
        ...
        { data_object: "bridge_3_tara_float_rx",                 port: "resistor_bridge_control[3]",         field: "bridge_tara_float" }
        ...
        { data_object: "bridge_3_serial_number_tx",              port: "resistor_bridge_status[3]",         field: "bridge_serial_number" }
        ...
        { data_object: "bridge_3_tara_float_tx",                 port: "resistor_bridge_status[3]",         field: "bridge_tara_float" }
        ...
        { data_object: "bridge_4_tara_float_rx",                 port: "resistor_bridge_control[4]",         field: "bridge_tara_float" }
        ...
        { data_object: "bridge_4_serial_number_tx",              port: "resistor_bridge_status[4]",         field: "bridge_serial_number" }
        ...
        { data_object: "bridge_4_tara_float_tx",                 port: "resistor_bridge_status[4]",         field: "bridge_tara_float" }
        ...
        { data_object: "bridge_5_tara_float_rx",                 port: "resistor_bridge_control[5]",         field: "bridge_tara_float" }
        ...
        { data_object: "bridge_5_serial_number_tx",              port: "resistor_bridge_status[5]",         field: "bridge_serial_number" }
        ...
        { data_object: "bridge_5_tara_float_tx",                 port: "resistor_bridge_status[5]",         field: "bridge_tara_float" }
        ...
        { data_object: "bridge_6_tara_float_rx",                 port: "resistor_bridge_control[6]",         field: "bridge_tara_float" }
        ...
        { data_object: "bridge_6_serial_number_tx",              port: "resistor_bridge_status[6]",         field: "bridge_serial_number" }
        ...
        { data_object: "bridge_6_tara_float_tx",                 port: "resistor_bridge_status[6]",         field: "bridge_tara_float" }
    ...
    properties:
        ...
        name:      {default: "m1acs_hw_adapter"}
        host:      {default: "127.0.0.1"}
        port:      {default: 9010}
        scan_rate: {default: 100}

    instance_configurations: ['m1acs_hw1_adapter']
