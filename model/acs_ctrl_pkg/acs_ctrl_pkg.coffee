...
Package   'acs_ctrl_pkg',
    ...
    connectors: [
        ...
        { id: 8103, from: { element: "acs_hw1_adapter", port: "ssi_in"},                  to: { element: "acs_main_ctrl",   port: "ssi_in"},                  max_latency: 0.5, nom_rate: 100, on_fault: "", conversion: "", bus: "" }
        { id: 8104, from: { element: "acs_hw1_adapter", port: "power_supply"},            to: { element: "acs_main_ctrl",   port: "power_supply"},            max_latency: 0.5, nom_rate: 100, on_fault: "", conversion: "", bus: "" }
        { id: 8105, from: { element: "acs_hw1_adapter", port: "resistor_bridge_status"},  to: { element: "acs_main_ctrl",   port: "resistor_bridge_status"},  max_latency: 0.5, nom_rate: 100, on_fault: "", conversion: "", bus: "" }
